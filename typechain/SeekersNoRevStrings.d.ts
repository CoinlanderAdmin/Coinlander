...
interface SeekersNoRevStringsInterface extends ethers.utils.Interface {
  functions: {
...
export class SeekersNoRevStrings extends BaseContract {
  ...
  interface: SeekersNoRevStringsInterface;
  ...
  callStatic: {
    ...
    birthSeeker(to: string, overrides?: CallOverrides): Promise<void>;
