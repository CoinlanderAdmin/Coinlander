...
interface CoinOneNoRevStringsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "_initKeepersVault(address)": FunctionFragment;
    ...
    "claimRefundAndShard()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_initKeepersVault",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "claimRefundAndShard",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class CoinOneNoRevStrings extends BaseContract {
  ...
  interface: CoinOneNoRevStringsInterface;
  ...
  callStatic: {
    ...
    claimRefundAndShard(overrides?: CallOverrides): Promise<void>;
